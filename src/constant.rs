...
pub(crate) const SDF_DOWNSCALE_FACTOR: f32 = 8.;
...
pub(crate) const COMPOSITE_SHADER: Handle<Shader> = Handle::weak_from_u128(43212314255795302531210625);
...
pub(crate) const RAYMARCH_SHADER: Handle<Shader>  = Handle::weak_from_u128(652123142557973608531210428);
// --------------------------------------
